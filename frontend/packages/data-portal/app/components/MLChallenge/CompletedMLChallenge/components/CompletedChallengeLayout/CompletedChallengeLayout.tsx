      ...
      <Section color="primary100" className="gap-sds-xl" useMdxStyles>
        ...
        <div
          className={cns(
            ...
            'bg-light-sds-color-primitive-gray-50 border border-light-sds-color-primitive-gray-200 rounded-sds-m shadow-card',
          )}
        >
          <div>
            <h4 className="text-sds-caps-xxxs-600-wide leading-sds-caps-xxxs tracking-sds-caps-xxxs-600-wide font-semibold uppercase text-light-sds-color-primitive-gray-500 mb-sds-xs">
        ...
        <div className="w-full h-sds-xxxs bg-light-sds-color-primitive-gray-200" />
