...
describe('non-compact', () => {
  ...
  it('should not render comma at end of list', () => {
    render(<AuthorList authors={DEFAULT_AUTHORS} />)

    expect(screen.getByRole('paragraph').textContent!.at(-1)).not.toBe(',')
  })
...
describe('compact', () => {
  ...
  it('should not render other or corresponding authors when compact', () => {
  ...
  it('should render ellipsis if compact and has corresponding authors', () => {
    render(<AuthorList authors={DEFAULT_AUTHORS} compact />)
    expect(
  ...
  it('should not render ellipsis if compact and no other or corresponding authors', () => {
    render(
      <AuthorList
