...
const NeuroglancerWrapper = ({ onStateChange, compressURL = true }: NeuroglancerWrapperProps) => {
  ...
  return (
    <iframe
      ...
      ref={iframeRef}
      src={`/neuroglancer/${superState.current.neuroglancer}`} // We need to give an uncompress hash initially
      title="Neuroglancer"
    />
  );
};
