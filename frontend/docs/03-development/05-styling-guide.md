...
This guide explains when to use Tailwind CSS, CSS Modules, and Material-UI for styling in the CryoET Data Portal frontend.
...
│
├─ Common utility styles (spacing, colors, text)?
│  → Use Tailwind CSS
│
├─ Component-specific complex styles (animations, pseudo-elements)?
│  → Use CSS Modules
│
├─ Pre-built interactive component (modal, menu, tooltip)?
│  → Use Material-UI (styled with Tailwind)
│
└─ Design system component?
   → Use CZI SDS components
```
...
1. **Tailwind CSS** (Primary) - Utility-first classes for 90% of styling
2. **CSS Modules** (Secondary) - Component-scoped styles for complex cases
3. **Material-UI** (Interactive) - Pre-built accessible components
4. **CZI SDS** (Design System) - Shared design tokens and components
...
### 1. Prefer Tailwind First

Start with Tailwind. Only use CSS Modules if Tailwind can't express what you need.

```typescript
// Good: Use Tailwind
<div className="flex items-center gap-4 p-4 rounded-lg border" />

// Avoid: Creating CSS Module for simple styles
<div className={styles.container} />  // where .container just has display: flex
```
