...
- [Table Page Layout](./03-table-page-layout.md) - Integrating drawers with tables
- [Component Patterns](./01-component-patterns.md) - General component structure
- [Hooks Guide](./08-hooks-guide.md) - More about useMetadataDrawer
