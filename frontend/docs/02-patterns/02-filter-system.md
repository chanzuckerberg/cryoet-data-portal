...
- [Table Page Layout](./03-table-page-layout.md) - How filters integrate with tables
- [GraphQL Integration](../01-architecture/03-graphql-integration.md) - Query patterns
- [Hooks Guide](./08-hooks-guide.md) - More custom hooks
