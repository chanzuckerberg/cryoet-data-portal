...
- [Component Patterns](./01-component-patterns.md) - Using i18n in components
- [Hooks Guide](./08-hooks-guide.md) - More about useI18n
- [Technology Stack](../01-architecture/01-technology-stack.md) - i18next setup
