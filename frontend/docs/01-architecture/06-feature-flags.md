...
```typescript
// Week 1: Local and dev only
newFeature: ['local', 'dev']

// Week 2: Add staging
newFeature: ['local', 'dev', 'staging']

// Week 3: Production rollout
newFeature: ['local', 'dev', 'staging', 'prod']

// Week 4+: Remove flag, feature is permanent
// Delete flag key and conditional logic
```
...
- [State Management](./04-state-management.md) - Managing feature-flag-dependent state
- [GraphQL Integration](./03-graphql-integration.md) - Conditional queries based on flags
- [Data Model](./07-data-model.md) - Understanding CryoET domain concepts
