...
- Recommended: for increased performance use the API through a AWS-EC2 instance from the region `us-west-2`. The CryoeET Portal data are hosted in a AWS-S3 bucket in that region.
...
Install the `cryoet_data_portal` package via pip:
