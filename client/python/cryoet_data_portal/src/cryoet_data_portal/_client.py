...
class Client:
    ...
    def __init__(self, url: Optional[str] = None):
        """Create a new client to interact with the CryoET Data Portal API

        Args:
            url:
                The API URL to connect to, defaults to "https://graphql.cryoetdataportal.cziscience.com/v1/graphql"
